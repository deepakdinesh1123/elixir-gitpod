defmodule Snowfall.GistsTest do
  use Snowfall.DataCase

  alias Snowfall.Gists

  describe "gists" do
    alias Snowfall.Gists.Gist

    import Snowfall.GistsFixtures
  ...
  describe "saved_gists" do
    alias Snowfall.Gists.SavedGist
